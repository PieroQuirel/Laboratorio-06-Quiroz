...
<body>
    <div class="container mt-4">
        <div class="row justify-content-center pt-5 mt-5 mr-1 text-center">
            <h1>Editar alumno</h1>
            <form name="formAlumno2" method="post" action="editar_registro.php">
                <table style="position:relative; margin:auto; width:100%;">
                    <tr class="row mb-3">
                    <input type="hidden" name="alumno_id" value="<?php echo $alumno['alumno_id'] ?>" required>
                        <td>Nombres</td>
                        <td>
                    ...
                    <tr class="row mb-3">
                        ...
                        <td>
                            <input type="text" name="ape_paterno" value="<?php echo $alumno['ape_paterno'] ?>" required>
                        </td>
                    </tr>
                    <tr class="row mb-3">
                        <td>Apellido Materno</td>
                        <td>
                            <input type="text" name="ape_materno" value="<?php echo $alumno['ape_materno'] ?>">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
